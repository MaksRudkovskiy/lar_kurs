<div class="left-bar dark:bg-c171717 pt-5 w-22 flex-col relative bgEDF1FF puk">
    ...
    <div class="conjoined-block mt-4 flex flex-col">
        <a href="{{ route('profile') }}" class="text-hover mx-4">
